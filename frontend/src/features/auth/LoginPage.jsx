...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex flex-col justify-center px-4 py-8 sm:px-6 lg:px-8">
      {/* Background Pattern */}
      ...
      <div className="relative w-full max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl mx-auto">
        <div className="flex flex-col items-center">
          <div className="h-12 w-12 sm:h-16 sm:w-16 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 flex items-center justify-center mb-4 sm:mb-6 shadow-lg">
        ...
        <div className="mt-6 sm:mt-8 bg-white py-6 sm:py-8 lg:py-10 px-4 sm:px-6 lg:px-10 xl:px-12 shadow-xl ring-1 ring-gray-200 rounded-2xl">
          {/* Google Login Button */}
          <div className="mb-6">
